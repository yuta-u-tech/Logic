% REVIEW-ID: logic.ch01.terms-predicates-propositions
% REVIEW-TITLE: 項・述語関数・命題
...
\begin{sidebox}[TBred]{記号を読む順序}
  \(P(a)\) では，括弧の外側の \(P\) が述語，括弧内の \(a\) がその述語を適用する個体である。まず「\(a\) は \(P\) である」と日本語に直すとよい。\(R(a,b)\) ならば「\(a\) は \(b\) と関係 \(R\) にある」と読む。
\end{sidebox}
