% REVIEW-ID: logic.ch02.semantics-and-syntax
% REVIEW-TITLE: 意味論と構文論
...
\begin{sidebox}[TBred]{構文論と意味論の見分け方}
  「この記号列は正しい論理式か」「どの規則から導けるか」は構文論の問いである。「どの対象を指すか」「どの解釈で真か」は意味論の問いである。\(\vdash\) は構文論，\(\vDash\) は意味論の記号として区別する。
\end{sidebox}
